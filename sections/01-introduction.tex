...
V kontexte informačných systémov na správu dokumentov (\gls{dms}) je použiteľnosť používateľského rozhrania obzvlášť dôležitá. Tieto systémy sú často využívané rôznorodými skupinami používateľov, 
...
Cieľom tohto dokumentu je analyzovať používateľské rozhranie vybranej webovej aplikácie typu \gls{dms} prostredníctvom základného používateľského testovania. 
